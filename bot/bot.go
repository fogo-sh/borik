...
func New() (*Borik, error) {
	...
	_ = parser.NewCommand("", "Magikify an image.", MakeImageOpCommandV6(Magik))
	_ = parser.NewCommand("magik", "Magikify an image.", MakeImageOpCommandV6(Magik))
	_ = parser.NewCommand("lagik", "Lagikify an image.", MakeImageOpCommandV6(Lagik))
	_ = parser.NewCommand("gmagik", "Repeatedly magikify an image.", MakeImageOpCommandV6(Gmagik))
	...
	_ = parser.NewCommand("waaw", "Mirror the right half of an image.", MakeImageOpCommandV6(Waaw))
	_ = parser.NewCommand("haah", "Mirror the left half of an image.", MakeImageOpCommandV6(Haah))
	_ = parser.NewCommand("woow", "Mirror the top half of an image.", MakeImageOpCommandV6(Woow))
	_ = parser.NewCommand("hooh", "Mirror the bottom half of an image.", MakeImageOpCommandV6(Hooh))
